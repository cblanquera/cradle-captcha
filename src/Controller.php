...
namespace Cradle\Framework\Captcha;
...
use Cradle\Framework\Captcha\Action\Captcha;
...
class Controller
{
    ...
    {
        $this->current = $this->actions['captcha'];
    ...
    {
        $this->actions['captcha'] = $this->resolve(Captcha::class, $app);
    }
